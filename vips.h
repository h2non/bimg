 ...
 *
 * Anyway, it's not possible to build vimgo on Debian Jessie with libvips 7.40.x,
 ...
 * In order to correctly build vimgo, for version < 7.41, we should undef vips_init and
